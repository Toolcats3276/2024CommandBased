...
public class AltUnderStageSmartAuto extends SequentialCommandGroup{

    
    public AltUnderStageSmartAuto(WristSS s_Wrists, ArmSS s_Arm, InfeedSS s_Infeed, ShooterSS s_Shooter, SensorSS s_Sensor) {

        addCommands(
            new SequentialCommandGroup(
                new PathPlannerAuto("alt_source_0-1"),
