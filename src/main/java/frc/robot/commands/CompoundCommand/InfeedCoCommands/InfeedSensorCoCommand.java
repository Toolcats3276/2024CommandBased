...
public class InfeedSensorCoCommand extends SequentialCommandGroup{

    
    public InfeedSensorCoCommand(WristSS s_Wrist, ArmSS s_Arm, InfeedSS s_Infeed, SensorSS s_Sensor, ShooterSS s_Shooter, LEDSS s_LED) {
