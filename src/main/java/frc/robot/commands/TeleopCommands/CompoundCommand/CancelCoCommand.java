...
public class CancelCoCommand extends SequentialCommandGroup{
    ...
    public CancelCoCommand(WristSS s_Wrist, ArmSS s_Arm, InfeedSS s_Infeed, ShooterSS s_Shooter, ClimberSS s_Climber, SensorSS s_Sensor, LEDSS s_LED, Swerve s_Swerve, DoubleSupplier WristAxis, DoubleSupplier ArmAxis) {
        ...
        addCommands(
            new ParallelCommandGroup(
                ...
                new InstantCommand(() -> s_Swerve.setAutoRotationState(false))
                )
        );
