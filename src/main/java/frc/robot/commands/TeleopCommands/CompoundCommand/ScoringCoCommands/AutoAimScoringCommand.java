...
public class AutoAimScoringCommand extends SequentialCommandGroup{

    public AutoAimScoringCommand(InfeedSS s_Infeed, ShooterSS s_Shooter, ArmSS s_Arm, WristSS s_Wrist, SensorSS s_Sensor, Swerve s_Swerve) {
        ...
        addCommands(
                new ConditionalCommand(
                    ...
                    new ConditionalCommand(
                        ...
                        new AutoAimSpeakerShotCoCommand(s_Shooter, s_Arm, s_Wrist, s_Infeed, s_Swerve), 
