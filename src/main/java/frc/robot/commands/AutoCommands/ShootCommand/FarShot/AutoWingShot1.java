...
public class AutoWingShot1 extends SequentialCommandGroup{



    public AutoWingShot1(InfeedSS s_Infeed, ShooterSS s_Shooter, ArmSS s_Arm, WristSS s_Wrist) {

        addCommands(
            // new SuckBackCoCommand(s_Infeed, s_Shooter),
            new ParallelCommandGroup(
                new WristPIDCommand(s_Wrist, WristConstants.WING_POS1, WristConstants.MAX_PID_OUTPUT),
