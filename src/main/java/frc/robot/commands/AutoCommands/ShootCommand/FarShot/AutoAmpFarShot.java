...
public class AutoAmpFarShot extends SequentialCommandGroup{



    public AutoAmpFarShot(InfeedSS s_Infeed, ShooterSS s_Shooter, ArmSS s_Arm, WristSS s_Wrist) {

        addCommands(
            // new SuckBackCoCommand(s_Infeed, s_Shooter),
            new ParallelCommandGroup(
                new WristPIDCommand(s_Wrist, WristConstants.AMP_FARSHOT_POS, WristConstants.MAX_PID_OUTPUT),
