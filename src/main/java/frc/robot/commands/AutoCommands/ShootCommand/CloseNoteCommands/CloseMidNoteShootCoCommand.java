...
public class CloseMidNoteShootCoCommand extends SequentialCommandGroup{



    public CloseMidNoteShootCoCommand(InfeedSS s_Infeed, ShooterSS s_Shooter, ArmSS s_Arm, WristSS s_Wrist) {
