...
public final class CTREConfigs {
    ...
    public CANcoderConfiguration climberCANcoderConfig = new CANcoderConfiguration();
    ...
    public CTREConfigs(){
        ...
        armCANcoderConfig.MagnetSensor.AbsoluteSensorRange = AbsoluteSensorRangeValue.Unsigned_0To1;

        climberCANcoderConfig.MagnetSensor.SensorDirection = SensorDirectionValue.Clockwise_Positive;
        climberCANcoderConfig.MagnetSensor.AbsoluteSensorRange = AbsoluteSensorRangeValue.Unsigned_0To1;
